...
export declare function getLabelsFromContext(context: any, service: string): LabelValues<string>;
export declare function countFieldAncestors(path: Path | undefined): string;
export declare function getLabelsFromFieldResolver({
  info: { fieldName, parentType, path, returnType }
}: GraphQLFieldResolverParams<any, any>): LabelValues<string>;
export declare function generateHooks(metrics: Metrics, service: string): ApolloServerPlugin;
