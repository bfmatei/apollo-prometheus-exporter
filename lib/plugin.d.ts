...
>;
export declare function toggleDefaultMetrics<C extends BaseContext = AppContext, S = Source, A = Args>(
  register: Registry,
  { defaultMetrics, defaultMetricsOptions }: Context<C, S, A>
): void;
export declare function setDefaultLabels<C extends BaseContext = AppContext, S = Source, A = Args>(
  register: Registry,
  { defaultLabels, hostnameLabel, hostnameLabelName }: Context<C, S, A>
): void;
export declare function toggleEndpoint<C extends BaseContext = AppContext, S = Source, A = Args>(
  register: Registry,
  { metricsEndpoint, app, metricsEndpointPath }: Context<C, S, A>
): void;
export declare function createPlugin<C extends BaseContext = AppContext, S = Source, A = Args>(
